...
2. NEUTRAL OBSERVATIONS
   ...
   - Example good: "You logged most days this week." Example bad: "Total logged tasks across the week: 0."
...
3. PRESCRIPTIVE SUGGESTIONS (safe, habit-based only)
   ...
   - Example: "Consider breaking tasks into smaller steps during busy days"

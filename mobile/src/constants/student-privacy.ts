import { COUNSELOR_VISIBLE_CHECKIN_SUMMARY } from "./counselor-checkin-policy";
...
export const STUDENT_PRIVACY_VISIBLE_PREVIEW =
  "Date, time, and mood for recent check-ins; directory info for scheduling.";
...
export const STUDENT_PRIVACY_NARROW_PREVIEW =
  "Notes, sleep, meals, bath, and photos stay off counselor views until then.";
export const STUDENT_PRIVACY_NARROW_DETAIL =
  "After special-population consent for that counselor, they can see the same journal detail you see in Aurora for support. There is no in-app switch to revoke that yet.";

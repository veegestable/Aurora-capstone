    ...
    <View className="flex-1">
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          ...
          return (
            <View
              className={`mb-3 p-4 rounded-xl border-l-4 ${styles.bg} border-gray-100 border-l-${styles.text.split("-")[1]}-500 shadow-xs`}
            >
              <View className="flex-row justify-between items-start">
                <View className="flex-1">
                  <View className="flex-row items-center mb-1">
                    <View
                      className={`px-2 py-0.5 rounded text-xs ${styles.badge} mr-2`}
                    >
                      <Text
                        className={`${styles.text} text-xs font-bold uppercase`}
                      >
                        {item.event_type}
                      </Text>
                    </View>
                ...
                <View className="flex-row gap-2">
                  <TouchableOpacity
                    ...
                    className="p-2 bg-white rounded-full shadow-xs"
                  >

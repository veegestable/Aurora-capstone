...
function InfoRow({ label, value }: { label: string; value: string }) {
  return (
    ...
    >
      <Text style={{ color: AURORA.textSec, fontSize: 11, marginBottom: 4 }}>
        {label}
      </Text>
        ...
        <SafeAreaView style={{ flex: 1 }}>
          ...
          >
            ...
            <TouchableOpacity onPress={handleSave} disabled={saving}>
              <Text
                style={{
                  color: saving ? AURORA.textMuted : AURORA.blue,
                  fontSize: 15,
                  fontWeight: "700",
                }}
              >
          ...
          >
            ...
            >
              Counselor Number <Text style={{ color: AURORA.red }}>*</Text>
            </Text>
            <View
              style={{
                backgroundColor: AURORA.card,
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        >
          ...
          <View style={{ paddingHorizontal: 22, paddingTop: 8 }}>
            <Text
              style={{ color: AURORA.textMuted, fontSize: 12, lineHeight: 17 }}
            >
            ...
            {pushNotifications && devicePermissionGranted === false ? (
              ...
              >
                Device notifications are blocked in system settings, so alerts
                may not appear.
              </Text>
            ) : null}
          </View>
          ...
          >
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  Your access to student data is governed by the MSU-IIT Privacy
                  Policy. You can view academic records and wellness logs only

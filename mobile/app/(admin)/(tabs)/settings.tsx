    ...
    <View style={{ flex: 1, backgroundColor: AURORA.bg }}>
      <SafeAreaView style={{ flex: 1 }}>
        ...
        >
          ...
          >
            Platform preferences and account. More options can be added here
            later.
          </Text>
          ...
          >
            <Text
              style={{ color: AURORA.textSec, fontSize: 12, marginBottom: 4 }}
            >
              Signed in as
            </Text>
            ...
            <Text
              style={{ color: AURORA.textMuted, fontSize: 14, marginTop: 4 }}
            >
              {user?.email}
            </Text>
          </View>
          ...
          >
            ...
            <Text
              style={{ color: AURORA.red, fontSize: 16, fontWeight: "700" }}
            >
              Log out
            </Text>
          </TouchableOpacity>

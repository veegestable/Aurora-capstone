...
export function EditProfileModal({ onClose, user }: EditProfileModalProps) {
  ...
  const handleSave = async () => {
    ...
    if (!programTrim) {
      alert('Please enter your program (e.g. BS Computer Science).')
      return
    }
    if (!yearTrim) {
      alert('Please enter your year level (e.g. 1st Year, 2nd Year).')
      return
    }
    if (!studentNumTrim) {
      ...
      <div className="bg-white rounded-2xl shadow-aurora-lg w-full max-w-lg max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          <div className="flex flex-col items-center mb-2">
            ...
            <p className="text-xs text-aurora-gray-500 mt-2">CCS &bull; MSU-IIT</p>
          </div>

          {/* Name */}
          <div>
            <label className="block text-sm font-semibold text-aurora-primary-dark mb-2">Name</label>
          ...
          <div>
            <label className="block text-sm font-semibold text-aurora-primary-dark mb-2">
              Program <span className="text-aurora-accent-red">*</span>
            </label>
            <input
              type="text"
              value={program}
          ...
          <div>
            <label className="block text-sm font-semibold text-aurora-primary-dark mb-2">
              Year Level <span className="text-aurora-accent-red">*</span>
            </label>
            <input
              type="text"
              value={yearLevel}
          ...
          <div>
            <label className="block text-sm font-semibold text-aurora-primary-dark mb-2">
              Student Number <span className="text-aurora-accent-red">*</span>
            </label>
            <input
              type="text"
              value={studentNumber}

  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-aurora-primary-dark mb-2">Daily Mood Check-In</h1>
        <p className="text-aurora-primary-dark/70">How are you feeling today? Let's capture your emotions.</p>
      </div>
      ...
      {isManualMode && (
        <div className="card-aurora">
          <h3 className="text-xl font-semibold mb-4 text-aurora-primary-dark">Select Your Emotions</h3>
              ...
              return (
                <button
                  ...
                  className={`p-4 rounded-lg border-2 transition-all hover:scale-105 ${
                    isSelected
                      ? 'border-aurora-secondary-blue bg-aurora-secondary-blue/10 shadow-aurora'
                      : 'border-aurora-primary-light/30 hover:border-aurora-primary-light/50 bg-white/50'
                  }`}
                  aria-label={`Select ${emotion.label} emotion`}
                >
                  <div className="text-3xl mb-2">{emotion.emoji}</div>
                  <div className="text-sm font-medium text-aurora-primary-dark">{emotion.label}</div>
                  <div
                    className="w-6 h-6 rounded-full mx-auto mt-2"
                    style={{ backgroundColor: emotion.color }}
                  />
                  {isSelected && (
                    <div className="mt-2 text-xs text-aurora-secondary-blue font-medium">✓ Selected</div>
                  )}
                </button>
              );
            })}
      ...
      <div className="card-aurora">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label htmlFor="energy-level" className="block text-sm font-medium text-aurora-primary-dark mb-2">
          ...
          <div>
            <label htmlFor="stress-level" className="block text-sm font-medium text-aurora-primary-dark mb-2">

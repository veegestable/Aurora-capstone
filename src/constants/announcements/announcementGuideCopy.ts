export const ANNOUNCEMENT_GUIDE_COUNSELOR = {
...
export const ANNOUNCEMENT_GUIDE_ADMIN = {
  title: 'How announcements work',
  body:
...
export type AnnouncementGuideAudience = 'counselor' | 'admin'

export function announcementGuideForAudience(audience: AnnouncementGuideAudience) {
  return audience === 'admin' ? ANNOUNCEMENT_GUIDE_ADMIN : ANNOUNCEMENT_GUIDE_COUNSELOR
}

        ...
        <div className="relative z-10 text-center animate-aurora-float w-full max-w-sm sm:max-w-md">
          <div className="bg-white/85 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-aurora-lg p-6 sm:p-8 lg:p-10 border border-aurora-blue-200/30 animate-aurora-glow">
            <div className="mb-4 sm:mb-6 lg:mb-8">
              <img src={logoDark} alt="Aurora" className="h-16 sm:h-20 lg:h-24 w-auto mx-auto filter drop-shadow-lg sm:drop-shadow-xl transition-all duration-700 hover:scale-105 sm:hover:scale-110 animate-aurora-glow" />
            </div>
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <p className="text-aurora-primary-dark/80 font-body text-base sm:text-lg lg:text-xl tracking-wide">Mental Health Companion</p>

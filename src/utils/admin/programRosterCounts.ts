...
/** CCS legacy free-text program lines (web signup uses catalog labels directly). */
function matchLegacyDepartmentToProgramValue(department?: string): string {
  ...
  if (options.includes(d)) return d
